...
kb_parts.add(btn_profiles).add(btn_corner).add(btn_screws).add(btn_sheets).add(btn_other).add(main_menu)
...
kb_produce.add(btn_lazermetal).add(btn_lazeracril).add(btn_other).add(main_menu)
